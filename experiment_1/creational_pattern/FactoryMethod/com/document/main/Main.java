...
public class Main {
    public static void main(String[] args) {
        ...
        if (app != null) {
            app.runApplication(); // This calls the Factory Method and initializes the document

            // --- CRITICAL CHANGE: Single Line Input ---
            System.out.print("\n[USER ACTION]: Write your content (one line only, press Enter to proceed): ");
            String userInput = scanner.nextLine(); // Reads the content immediately

            // --- DOCUMENT INTERACTION (Client's Responsibility) ---

            // Simulate saving the user input
            ...
            if (scanner.nextLine().trim().equalsIgnoreCase("y")) {
                System.out.println("\n--- SAVED CONTENT ---");
                // Display the single line of content
